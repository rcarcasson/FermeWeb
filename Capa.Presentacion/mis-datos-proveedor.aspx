<%@ Page Title="" Language="C#" MasterPageFile="~/Proveedor.Master" AutoEventWireup="true" CodeBehind="mis-datos-proveedor.aspx.cs" Inherits="Capa.Presentacion.mis_datos_proveedor" %>
    ...
    <asp:Panel ID="panelDatos" runat="server">
       <h3 class="p-3">Mis Datos</h3>
        ...
        <div class="form-row p-3">
            ...
            <div class="col-4">
                <asp:TextBox ID="txtRubro" runat="server" CssClass="form-control" Placeholder="Rubro" MaxLength="20" ValidationGroup="MisDatos"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Campo obligatorio" ControlToValidate="txtRubro" Display="Dynamic" ForeColor="Red" ValidationGroup="MisDatos"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-row p-3">
            <div class="col-2">
